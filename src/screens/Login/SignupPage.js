                    ...
                    <div className="p-12 relative bg-black text-white">
                        <div className="space-y-8">
                            ...
                            <Form name="signup" onFinish={onFinish} className="space-y-6">
                                ...
                                <Form.Item name="registrationNumber" rules={[{ required: true, message: 'Please input your registration number!' }]}>
                                ...
                                <Form.Item name="password" rules={[{ required: true, message: 'Please input your password!' }]}>
                                    <Input.Password placeholder="Password" iconRender={(visible) => visible ? <EyeOff size={20} /> : <Eye size={20} />} />
                                </Form.Item>
                                ...
                                <Form.Item name="agreeTerms" valuePropName="checked" rules={[{ validator: (_, value) => value ? Promise.resolve() : Promise.reject(new Error('You must agree to the terms and conditions')) }]}>
                                    <Checkbox> I agree to the <Button type="link" onClick={() => setIsModalOpen(true)} className="p-0 text-[#3533cd] hover:underline">Terms and Conditions</Button></Checkbox>
                                </Form.Item>
                                <Form.Item>
                                    <Button type="primary" htmlType="submit" loading={isLoading} className="w-full">{isLoading ? 'Signing up...' : 'Sign up'}</Button>
                                </Form.Item>
                            </Form>
