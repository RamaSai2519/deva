    ...
    return (
        <div style={{ minHeight: '100vh', backgroundColor: '#000', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
            <Card style={{ borderRadius: '32px', width: '100%', maxWidth: '1000px', overflow: 'hidden' }}>
                <Row gutter={[0, 0]} md={{ span: 24, flex: 'none' }}>
                    <Col md={12} style={{ backgroundColor: '#f5f5f5', padding: '48px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <div style={{ width: '100%', maxWidth: '400px' }}>
                            <AnimatedScene mousePosition={mousePosition} isPasswordVisible={isPasswordVisible} />
                        </div>
                    </Col>
                    <Col md={12} style={{ padding: '48px', position: 'relative', backgroundColor: '#000', color: '#fff' }}>
                        ...
                        <div style={{ marginTop: '32px' }}>
                            <h1 style={{ fontSize: '24px', fontWeight: '600', marginBottom: '8px' }}>Your Profile</h1>
                        ...
                        <div style={{ marginTop: '32px' }}>
                            <h3 style={{ fontSize: '18px', fontWeight: '500', color: '#fff' }}>Account Activity</h3>
