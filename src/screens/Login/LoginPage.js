                                ...
                                <div className="flex items-center justify-between">
                                    <label className="flex items-center gap-2">
                                        <input
                                            ...
                                            className="rounded bg-zinc-800 border-zinc-700 text-[#3533cd]"
                                        />
                                        <span className="text-sm text-gray-400">Remember for 30 days</span>
                                    </label>
                                    <Link to="/account" className="text-sm text-gray-400 hover:text-gray-300">
                                        Forgot password?
                                    </Link>
                                </div>
