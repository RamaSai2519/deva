    ...
    return (
        <div className="relative">
            <div className="pointer-events-none absolute inset-0 opacity-[0.85]" aria-hidden="true">
                <CommitGraphBG paused={prefersReducedMotion} />
            </div>
            <div id="intro" className="relative z-10 flex flex-col items-center justify-between p-5">
                ...
                <GiantPopup visible={showPopup} setVisible={setShowPopup}>
                    <div className="max-w-3xl mx-auto py-6 sm:py-10 space-y-4 sm:space-y-6 text-mutedWhite">
                        ...
                        <p className="text-sm sm:text-base md:text-lg text-slate-200 leading-relaxed">
                            ...
                            tournaments, and GitHub-focused workshops like Open Source Contribution and GitHub Pages.
                        </p>
